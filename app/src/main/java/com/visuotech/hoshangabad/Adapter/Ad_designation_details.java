...
public class Ad_designation_details extends RecyclerView.Adapter<Ad_designation_details.MyViewHolder> {
    ...
    public Ad_designation_details(Context context, ArrayList<PollingBooth> list, String[] designation_list) {
        this.list = list;
    ...
    public int getItemCount() {
        return designation_list.length;
    }
...
//            });
    ...
    public void filterList(ArrayList<PollingBooth> polling_list2) {
