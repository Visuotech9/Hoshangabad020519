package com.visuotech.hoshangabad_election.Activities.Election.Hoshangabad;
...
public class Act_hoshangabad extends AppCompatActivity {
    LinearLayout lay1,lay2,lay3,lay4,lay5,lay6;
    TextView tv_wave,tv_cctv,tv_all;

    LinearLayout container;
    String AC="137- Hoshangabad";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("137- Hoshangabad");
        ...
        tv_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Act_hoshangabad.this, Act_polling_station.class);
                i.putExtra("CITY",AC);
                i.putExtra("CONST","");
                startActivity(i);
...
//                });
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(Act_hoshangabad.this)
                .setMessage(message)
...
//                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent i = new Intent(Act_hoshangabad.this, Act_election.class);
        startActivity(i);
        finish();
        return true;
