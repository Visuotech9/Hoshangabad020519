...
public class Ad_dept_members extends RecyclerView.Adapter<Ad_dept_members.MyViewHolder> {
    ArrayList<Deaprtments_members> list;
    Context context;
    String dept_name;


    public Ad_dept_members(Context context, ArrayList<Deaprtments_members> list, String dept_name) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_dept_members,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int i) {
        ...
        holder.tv_samitee.setText(dept_name);
        holder.tv_resp.setText(list.get(i).getDept_officer_duty());
        holder.tv_name.setText(list.get(i).getDept_officer_name());
        holder.tv_designation.setText(list.get(i).getDept_officer_designation());
        holder.tv_mobile.setText(list.get(i).getDept_officer_mobile());
        holder.tv_posting.setText(list.get(i).getDept_officer_posting());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tv_name,tv_designation,tv_mobile,tv_samitee,tv_resp,tv_posting;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv_posting =  itemView.findViewById(R.id.tv_posting);
    ...
    public void filterList(ArrayList<Deaprtments_members> polling_list2, String samitee_name) {
        this.list = polling_list2;
        this.dept_name=samitee_name;
